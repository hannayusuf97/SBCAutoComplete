...
from formations import fouronetwonetwo, fourfourtwo, fourtwotwotwo, fourthreeonetwo
...
none_checkbox = tk.Radiobutton(window, text="None", variable=quality_var, value="None")
